...
const BookRoomTime = () => {
    ...
    return (
        <div className='bg-teal-400 relative  shadow-lg rounded-lg'>
            <div className='flex flex-wrap   items-center justify-between px-3 py-4'>
                ...
                <button
                    onClick={handleBook}
                    className='w-full lg:w-auto mt-10 lg:m-0 bg-emerald-600 px-4 py-2 text-4xl italic text-white font-mono hover:bg-teal-800 '>
                    Book
                </button>
            </div>
        </div>
