    ...
    return (
        <div>
            ...
            <div className='flex gap-9 justify-between p-5 flex-wrap'>
                ...
                <div className='flex-1 flex items-start justify-between flex-row-reverse flex-wrap '>
                    ...
                    <div className='flex-1 w-full md:w-9/12'>
                        ...
                        <div className='mt-6 flex justify-between flex-wrap items-center flex-roceverse'>
