...
const error = ({ error, reset }: ErrorPageProps) => {
    return (
        <div className=" fix-height  pt-7 text-center">
            ...
            <h1 className="text-gray-700 my-3 text-xl">Error Massge  : {error.message}</h1>
            ...
            <Link className="text-xl underline text-blue-700 block mt-6" href={"/dashboard/users"}>Go to users page</Link>
        </div>
    )
}
